...
export default function AdminLayout({
      ...
      >
        <motion.div
          ...
          className={`w-12 h-12 border-4 rounded-full ${
            theme === "dark" ? "border-purple-500 border-t-transparent" : "border-blue-500 border-t-transparent"
          }`}
        />
      </motion.div>
    )
  ...
  // Definir un ancho constante para el sidebar para evitar saltos
  const SIDEBAR_WIDTH = 260 // en pixeles
  ...
  return (
    ...
    >
      ...
      {/* Sidebar con dimensiones fijas */}
      <motion.aside
        initial={false}
        animate={{
          x: sidebarOpen ? 0 : isMobile ? -SIDEBAR_WIDTH : -SIDEBAR_WIDTH,
          width: SIDEBAR_WIDTH,
        }}
        transition={{
          type: "spring",
        ...
        } flex flex-col h-full shadow-[0_0_15px_rgba(0,0,0,0.05)] overflow-hidden`}
      ...
      {/* Main content con dimensiones ajustadas para eliminar el espacio vacío */}
      <motion.div
        initial={false}
        animate={{
