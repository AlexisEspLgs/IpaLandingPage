...
import { BookOpen, Save, RefreshCw, FileText, ImageIcon } from "lucide-react"
...
export default function AdminHistoriaPage() {
  ...
  const fetchConfig = async () => {
    ...
    try {
      ...
      setMessage("Error al cargar la configuración de la sección Historia")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-900 dark:to-purple-900 text-white rounded-lg shadow-lg">
        <div className="px-6 py-8">
          <motion.div variants={item} className="flex items-center space-x-3">
            ...
            <h1 className="text-3xl font-bold">Sección Historia</h1>
          </motion.div>
          <motion.p variants={item} className="text-blue-100 dark:text-blue-200 mt-2">
            Personaliza el contenido de la sección de Historia
          </motion.p>
        </div>
      </div>
