...
export function Inicio() {
  return (
    <section id="inicio" className="pt-14 bg-gradient-to-r from-primary to-secondary text-white min-h-screen flex items-center">
  ...
  <Image
    ...
    width={200}
    height={200}
    className="mx-auto -mt-8 mb-8 rounded-full border-4 border-white shadow-lg animate-pulse"
  />
