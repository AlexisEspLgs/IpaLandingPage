      ...
      <div className="container mx-auto mb-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="relative h-64 md:h-96 flex items-center">
            <button
              className="absolute left-0 z-10 bg-white bg-opacity-50 p-2 rounded-full text-primary hover:bg-primary hover:text-white transition-all duration-200 transform -translate-x-1/2"
              onClick={() => paginate(-1)}
            >
              <ChevronLeft size={24} />
            </button>
          ...
          <div className="text-center mt-4 mb-4 text-text-light transparent ">
