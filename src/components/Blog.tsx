  ...
  return (
    <section id="blog" className={`py-20 px-2 sm:px-4 ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="container mx-auto">
        <h2 className={`text-3xl font-bold text-center mb-12 ${theme === 'dark' ? 'text-gray-100' : 'text-primary'}`}>Últimos Artículos</h2>
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className={`text-xl font-semibold mb-2 ${theme === 'dark' ? 'text-gray-100' : 'text-primary'}`}>{post.title}</h3>
                <div 
